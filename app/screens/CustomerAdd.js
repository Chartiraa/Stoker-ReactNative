    ...
    return (
        <>
            <ScrollView>
                ...
                <TextInput autoCapitalize='characters' placeholderTextColor={colors.inputPlaceholder} onChangeText={(e) => setName(e)} style={styles.input} placeholder='İsim' />

                <TextInput autoCapitalize='characters' placeholderTextColor={colors.inputPlaceholder} onChangeText={(e) => setSurname(e)} style={styles.input} placeholder='Soyisim' />

                <TextInput placeholderTextColor={colors.inputPlaceholder} onChangeText={(e) => setTc(e)} style={styles.input} keyboardType='number-pad' placeholder='TC Kimlik No' />

                <TextInput placeholderTextColor={colors.inputPlaceholder} onChangeText={(e) => setTel(e)} style={styles.input} keyboardType='phone-pad' placeholder='Telefon No' />
